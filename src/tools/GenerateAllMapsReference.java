...
public class GenerateAllMapsReference {
    ...
    private static void generateMovementTest(File outputDir) throws Exception {
        ...
        md1.startDate = 0; md1.position = 127.0; md1.transitionTo = 0.0; md1.endDate = 2880.0; md1.controller = "sustain";
        movMap.addMovement(md1);
        MovementData md2 = new MovementData();
        md2.startDate = 2880.0; md2.position = 0.0; md2.transitionTo = 127.0; md2.endDate = 5760.0; md2.controller = "sustain";
    ...
    private static void generateAllMapsTest(File outputDir) throws Exception {
        ...
        mdAll.startDate = 0; mdAll.position = 127.0; mdAll.transitionTo = 0.0; mdAll.endDate = 2880.0; mdAll.controller = "sustain";
